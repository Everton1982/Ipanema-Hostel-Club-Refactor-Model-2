...
//alert("oi mundo")
var awstatsmisctrackerurl="/mkte_x/_biblioteca/scripts/awstats_misc_tracker.js";
...
if (window.location.search == "" || window.location.search == "?") {
	...
	if( document.createElementNS ) {
		...
		document.write('<img style="display:none;" src="../_biblioteca/scripts/'+ imgsrc +'" height="0" width="0" border="0" />')
	}
